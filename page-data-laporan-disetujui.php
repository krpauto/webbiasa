                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-bordered table-striped" id="dataTable1">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT user.nama_lengkap, laporan.id_laporan, laporan.judul, laporan.tanggal_upload, laporan.file, laporan.komentar, laporan.status FROM laporan LEFT JOIN user ON laporan.id_user=user.id_user WHERE laporan.status ='Disetujui' ";
